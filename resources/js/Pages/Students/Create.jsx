...
export default function Create({ rombels }) {
    const { data, setData, post, processing, errors } = useForm({
        nama_lengkap: '', nama_panggilan: '', nipd: '', nisn: '', rombel_id: '', agama: '', jenis_kelamin: 'L',
        tempat_lahir: '', tanggal_lahir: '', alamat: '', rt: '', rw: '', desa_kelurahan: '',
        kecamatan: '', kabupaten: '', provinsi: '', kode_pos: '', no_telepon: '', email: '',
        nama_ayah: '', pekerjaan_ayah: '', no_telepon_ayah: '', alamat_ayah: '',
        nama_ibu: '', pekerjaan_ibu: '', no_telepon_ibu: '', alamat_ibu: '',
        nama_wali: '', pekerjaan_wali: '', no_telepon_wali: '', alamat_wali: '',
        nama_wali_murid: '', pekerjaan_wali_murid: '', no_telepon_wali_murid: '', alamat_wali_murid: ''
    });
        ...
        <AppLayout title="Tambah Siswa">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-4 bg-slate-50">
                    ...
                    <div>
                        <p className="font-bold text-slate-800 text-lg">Form Tambah Siswa</p>
                        <p className="text-xs text-slate-500 mt-0.5">Lengkapi data identitas, alamat, dan data orang tua siswa</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="p-6">
                    ...
                    <div className="pt-6 border-t border-slate-100 flex justify-end gap-3 sticky bottom-0 bg-white/90 backdrop-blur-sm py-4">
                        ...
                        >
                            <Save className="w-4 h-4 mr-1.5" /> {processing ? 'Menyimpan...' : 'Simpan Siswa'}
                        </button>
                    </div>
                </form>
            </div>
