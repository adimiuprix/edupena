...
export default function Create({ mapels, kelasOptions, semesters }) {
    ...
    return (
        <AppLayout title="Tambah TP">
            <div className="max-w-2xl bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="px-5 py-4 border-b bg-slate-50 font-bold text-slate-800">Tambah Tujuan Pembelajaran</div>
